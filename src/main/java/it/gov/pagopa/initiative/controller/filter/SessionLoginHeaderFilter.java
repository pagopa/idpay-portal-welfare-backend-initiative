...
public class SessionLoginHeaderFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        String organizationUserId = ((HttpServletRequest) request).getHeader("organization_user_id");
        if(StringUtils.isBlank(organizationUserId)){
            organizationUserId = ((HttpServletRequest) request).getHeader("x-organization_user_id");
        }
        ...
        log.info("[FILTER] HEADER organizationUserId: {}", organizationUserId);
        log.info("[FILTER] HEADER organizationUserId: {}", ((HttpServletRequest) request).getHeader("x-organization_user_id"));
