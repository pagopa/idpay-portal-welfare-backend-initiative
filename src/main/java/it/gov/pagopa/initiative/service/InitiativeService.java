...
public interface InitiativeService {
    ...
    OnboardingDTO getOnboardingStatusList(String organizationId, String initiativeId, String cf, Instant startDate, Instant endDate, String status, Pageable pageable);
