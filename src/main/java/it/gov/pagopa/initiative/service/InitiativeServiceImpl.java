...
//                break;
    ...
    public Initiative sendInitiativeInfoToIOBackEndServiceAndUpdateInitiative(Initiative initiative, InitiativeOrganizationInfoDTO initiativeOrganizationInfoDTO) {
        ...
        //FIXME: Choose a different Algo to evict java.security.InvalidAlgorithmParameterException: Cannot reuse iv for GCM encryption
//        String encryptedPrimaryToken = serviceResponseDTO.getPrimaryKey();
