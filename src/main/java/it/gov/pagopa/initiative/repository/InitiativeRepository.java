...
public interface InitiativeRepository extends MongoRepository<Initiative, String>, InitiativeRepositoryExtended {
    ...
    @Query(value="{organizationId : ?0, enabled: ?1}", fields="{initiativeId : 1, initiativeName : 1,initiativeRewardType : 1, status : 1, 'additionalInfo.serviceName' : 1, creationDate : 1, updateDate : 1, 'general.rankingEnabled' : 1, 'general.endDate' : 1, 'general.startDate' : 1, additionalInfo.serviceId:1 , organizationName: 1}")
