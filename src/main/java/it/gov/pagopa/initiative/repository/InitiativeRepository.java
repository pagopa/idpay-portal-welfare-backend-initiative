...
public interface InitiativeRepository extends MongoRepository<Initiative, String> {
    ...
    @Query(value="{initiativeId : ?0}", fields="{initiativeId : 1, initiativeName : 1, status : 1, 'additionalInfo.serviceName' : 1, 'general' : 1, 'beneficiaryRule' : 1, 'rewardRule' : 1, 'trxRule' : 1}")
