...
class GroupRestConnectorTest {
    ...
    void testNotifyInitiativeToGroup() {
        ...
        initiative.setCreationDate(LocalDate.of(1, 1, 1).atTime( 1, 1).atZone(zone).toInstant());
        ...
        initiative.setUpdateDate(LocalDate.of(1, 1, 1).atTime( 1, 1).atZone(zone).toInstant());
